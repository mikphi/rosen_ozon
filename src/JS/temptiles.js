...
var TEMPITEMS = [
    { tileid: 35, name: "Camme Pipps", img: "persons/1.png", smallimg:"persons/1head.png", color: "#6ED2FA", energy: 100, playerid: 1, itemid: 1000, mapid: 10, type: "person", persontype:"lanare",  invehicle: true, persontype: "ragger", charecteristics: {}, weapons: { }  },
...
{ tileid: 90, name: "Biggie Blackie", img: "persons/1.png", smallimg: "persons/1head.png", color: "#6ED2FA", energy: 60, playerid: 1, itemid: 1002, mapid: 10, type: "person",persontype:"lanare", invehicle: false, persontype: "thug"  },
    { tileid: 35, name: "Snickar- boan", img: "persons/1.png", smallimg: "persons/1head.png", color: "#6ED2FA", energy: 40, playerid: 1, itemid: 1003, mapid: 10, type: "person", persontype: "lanare", invehicle: false, persontype: "thug"  },
    ...
    { tileid: 7, name: "Hektor Sandf�lt", img: "persons/1.png", smallimg: "persons/1head.png", color: "#02ff2c", energy: 60, playerid: 10, itemid: 1004, mapid: 10, type: "person", persontype: "lanare", invehicle: false, persontype: "thug"  },
