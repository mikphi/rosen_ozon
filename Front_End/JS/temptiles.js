...
{ tileid: 90, name: "Biggie Blackie", img: "persons/1.png", smallimg: "persons/1head.png", color: "#6ED2FA", energy: 60, playerid: 1, itemid: 1002, mapid: 10, type: "person",persontype:"lanare", invehicle: false, persontype: "thug"  },
    ...
    { tileid: 105, name: "John Häggerud", img: "persons/1.png", smallimg: "persons/1head.png", color: "#6ED2FA", energy: 100, playerid: 1, itemid: 1346, mapid: 10, type: "person", persontype: "lanare", invehicle: false, persontype: "thug"  },
    ...
    { tileid: 105, name: "saab 900 knack", img: "vehicles/saab900.png", color: "#6ED2FA", energy: 10, playerid: 1, itemid: 2000, mapid: 10, type: "vehicle",vehicletype:"car", seats: 5, passengers: [1000, 1001], fuelcapacity: 60  },
      { tileid: 35, name: "900 loose can edt", img: "vehicles/saab900.png", color: "#6ED2FA", energy: 50, playerid: 1, itemid: 2020, mapid: 10, type: "vehicle",vehicletype:"car", seats: 5, passengers: [], fuelcapacity: 60  },
       { tileid: 35, name: "900 tjuv edt", img: "vehicles/saab900.png", color: "#6ED2FA", energy: 50, playerid: 1, itemid: 2021, mapid: 10, type: "vehicle", seats: 5,vehicletype:"car", passengers: [], fuelcapacity: 60  },
        { tileid: 35, name: "saab 900 megamaxi", img: "vehicles/saab900.png", color: "#6ED2FA", energy: 50, playerid: 1, itemid: 2022, mapid: 10, type: "vehicle", seats: 5,vehicletype:"car", passengers: [], fuelcapacity: 60  }
     ]
